...
import Icono39 from "../img/39_dots.svg";
import Icono40 from "../img/40_dots-white.svg";
import Icono41 from "../img/41_save.svg";
...
export const IMAGENES = {
  svg: {
    perfil: { light: Icono1, dark: Icono2 },
    home: { light: Icono3, dark: Icono4 },
    comunidadesMias: { light: Icono5, dark: Icono6 },
    tendencias: { light: Icono7, dark: Icono8 },
    lupa: { light: Icono9, dark: Icono10 },
    comunidadGeneral: { light: Icono11, dark: Icono12 },
    mas: { light: Icono13, dark: Icono14 },
    comentario: { light: Icono15, dark: Icono16 },
    like1: { light: Icono17, dark: Icono18 },
    like2: { light: Icono19, dark: Icono20 },
    retweet: { light: Icono21, dark: Icono22 },
    cartera: { light: Icono23, dark: Icono24 },
    emoji: { light: Icono25, dark: Icono26 },
    gif: { light: Icono27, dark: Icono28 },
    image: { light: Icono29, dark: Icono30 },
    message: { light: Icono31, dark: Icono32 },
    share: { light: Icono33, dark: Icono34 },
    more: { light: Icono35, dark: Icono36 },
    exit: { light: Icono37, dark: Icono38 },
