  ...
  const fetchSavedPosts = async () => {
    try {
      ...
      const response = await fetch(
        `http://127.0.0.1:8000/api/users/${user.id}/saved-posts`,
        {
          headers: {
      ...
      <div className="main-layout-container">
        <main className="main-content" style={{ padding: 0 }}>
          ...
          >
            ...
            >
              {posts.length}{" "}
              {posts.length === 1 ? "post guardado" : "posts guardados"}
            </p>
          </div>
          ...
          {!loading && !error && posts.length === 0 && (
            ...
            >
              ...
              <p style={{ margin: 0, fontSize: "15px" }}>
                Guarda posts para verlos más tarde haciendo clic en el icono de
                marcador
              </p>
            </div>
          )}
