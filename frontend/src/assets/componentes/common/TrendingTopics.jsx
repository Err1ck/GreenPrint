...
function TrendingTopics() {
    ...
    const fetchTrending = async () => {
        try {
            ...
            const response = await fetch('http://127.0.0.1:8000/api/hashtags/trending', {
                headers: headers
            });
    ...
    if (loading) {
        return (
            <div style={{
                ...
                <p style={{ color: "#536471", fontSize: "15px" }}>Cargando tendencias...</p>
            </div>
        );
    }
        ...
        <div style={{
            ...
            {trending.map((item, index) => (
                <div
                    ...
                    style={{
                        padding: "12px 16px",
                        borderBottom: index < trending.length - 1 ? "1px solid #eff3f4" : "none",
                        cursor: "pointer",
