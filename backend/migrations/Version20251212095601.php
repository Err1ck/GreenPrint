 ...
 */
final class Version20251212095601 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE community_members (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, community_id INT NOT NULL, role VARCHAR(20) DEFAULT \'member\' NOT NULL, created_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_6165BBACA76ED395 (user_id), INDEX IDX_6165BBACFDA7B0BF (community_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
